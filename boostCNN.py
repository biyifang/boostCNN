...
parser.add_argument('--momentum', default=0.0, type=float, metavar='M',
                    help='momentum')
parser.add_argument('--boost_shrink', default=0.2, type=float, metavar='S',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        train_sampler_random = torch.utils.data.RandomSampler(train_dataset)
    ...
    for k in range(args.num_boost_iter):
        ...
        # train for one epoch
        f, g = train(train_loader_random, train_loader_seq,weight_loader,weight_dataset, train_dataset, model, optimizer, k, f, g, args)
...
def train(train_loader_random, train_loader_seq, weight_loader, weight_dataset, train_dataset, model, optimizer, k, f, g, args):
