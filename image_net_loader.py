...
ARCHIVE_DICT = {
    'train': {
        'url':
        'http://www.image-net.org/challenges/LSVRC/2012/nnoupb/ILSVRC2012_img_train_100.tar',
        'md5': '8ec06911c222b39f794280d5089b3ab3',
    },
    'val': {
        'url':
...
class SubImageNet(ImageFolder):
    ...
    def __init__(self, root, split='train', download=False, **kwargs):
        ...
        super(SubImageNet, self).__init__(self.split_folder, **kwargs)
        self.root = root
