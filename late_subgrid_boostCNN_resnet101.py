...
from resNet101_self import ResNet
from resNet101_self import GBM
...
def main_worker(gpu, ngpus_per_node, args):
	...
	if args.teacher_model_save:
		...
		for epoch in trange(args.start_epoch, args.epochs):
			...
			if acc1 == best_acc1:
				...
				model.cpu()
				torch.save(model, args.data_name+'_teacher_model_resnet50')
				model.cuda()
	...
	if args.data_name == 'cifar10':
		model_2 = torch.load(args.data_name+'_teacher_model_resnet50')
	elif args.data_name == 'svhn':
		model_2 = torch.load('SVHN_teacher_model_resnet50')
	elif args.data_name == 'imagenet':
		model_2 = torch.load(args.data_name+'_teacher_model_resnet50')
